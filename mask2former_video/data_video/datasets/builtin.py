...
# ==== Predefined splits for OVIS SCRIBBLE ===========
_PREDEFINED_SPLITS_OVIS_SCRIBBLE = {
    "ovis_scribble_train": ("ovis/train",
                         "ovis/train_scribble.json"),
}
...
def register_all_ovis_scribble(root):
    for key, (image_root, json_file) in _PREDEFINED_SPLITS_OVIS_SCRIBBLE.items():
        # Assume pre-defined datasets live in `./datasets`.
        register_ytvis_instances(
            key,
            _get_ovis_instances_meta(),
...
if __name__.endswith(".builtin"):
    ...
    register_all_ovis_scribble(_root)
